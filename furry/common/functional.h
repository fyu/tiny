#ifndef FURRY_COMMON_FUNCTIONAL_H_
#define FURRY_COMMON_FUNCTIONAL_H_
...
//     size_t seed = 0;
//     boost::hash_combine(seed, hash<T1>(p.first));
//     boost::hash_combine(seed, hash<T2>(p.second));
//     return seed;
//   }
// };
...
// Implementation of function traits from kennytm
// copyright notice:
...
template <template <typename, typename> class Container, typename T1, typename T2, typename Function>
//Container<typename boost::function_types::result_type<Function>::type, T2>
//Container<T1, T2>
Container<typename function_traits<Function>::result_type, T2>
Map(const Container<T1, T2> &array, Function func) {
  //Container<T1, T2> result;
  //Container<typename boost::function_types::result_type<Function>::type, T2> result;
  Container<typename function_traits<Function>::result_type, T2> result;
